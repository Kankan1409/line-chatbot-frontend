...
import { FaHome } from "react-icons/fa"; // นำเข้าไอคอนรูปบ้านจาก react-icons
import "./Navbar.css"; // ไฟล์ CSS สำหรับ Navbar

const Navbar = () => {
  const [isMenuOpen, setIsMenuOpen] = useState(false); // State สำหรับควบคุมการเปิด/ปิดเมนู

  const toggleMenu = () => {
    setIsMenuOpen(!isMenuOpen); // สลับสถานะเปิด/ปิดเมนู
  };
  ...
  return (
    <nav className="navbar">
      ...
      {/* เมนูที่เลื่อนออกมาจากด้านซ้าย */}
      <div className={`menu ${isMenuOpen ? "open" : ""}`}>
        {/* โลโก้และชื่อร้าน */}
        <div className="menu-header">
          <h3 className="menu-title">ร้านทองโอ้วซุนเซ้ง</h3>
          <img src="/asset/images/aom.png" alt="โลโก้ร้าน" className="menu-logo" />
        </div>
        ...
        <ul>
          ...
          <li>
            <Link to="/shop" onClick={closeMenu}>ร้านค้า</Link>
          </li>
          <li>
            <Link to="/promo" onClick={closeMenu}>โปรโมชั่น</Link>
          </li>
          <li>
            <Link to="/contact" onClick={closeMenu}>ติดต่อเรา</Link>
          </li>
        </ul>
      </div>

      {/* Overlay สำหรับปิดเมนูเมื่อคลิกนอกพื้นที่ */}
      <div
